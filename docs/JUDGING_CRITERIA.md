...
| Data Analytics — 20 | Deterministic Rice/public artifacts, 78 match records, hashed GTFS refresh, hourly reconciliation, seasonal-naive comparison, physical invariants, city differentiation, and no silent fallback | Replace estimated OSM fixtures and the five unavailable GTFS results with validated evidence |
