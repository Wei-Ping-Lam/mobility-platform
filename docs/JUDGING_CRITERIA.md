...
| --- | --- | --- |
| Impact — 25 | Decision Brief exposes match-level gap, Pareto options, cost, VMT/CO2e, heat, and cumulative horizon outcomes; all 78 matches have capacity-qualified gap results and 29 expose observed zero scheduled capacity in the half-mile catchment | Confirm special-event operating plans and compare future observed outcomes without causal claims |
| Data Analytics — 20 | Deterministic Rice/public artifacts, 78 event-valid match calendars, hashed GTFS/OSM, hourly reconciliation, seasonal-naive comparison, physical invariants, component-level evidence states, and no silent fallback | Add local operations/ridership observations; resolve the 23 route/heat-partial matches and three Rice venue-coverage limitations |
| Innovation — 15 | Exact match-scoped Pareto sets, an all-city physical access-priority order separate from strict MRS, and capital-safe cumulative ledgers | Demonstrate why the frontier changes with city evidence and assumptions in the final pitch |
...
4. Open **Compare Cities** and distinguish the 11-city physical access priority from the 8-city strict secondary MRS.
