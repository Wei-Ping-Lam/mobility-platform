...
| Published traffic controls | `traffic_strategy_plans[*].published_controls`, `.official_plan_available` | Exact named facilities or controls only for the city and source that published them | Dallas only; generated strategies for other cities contain no invented closures or approved curb locations |
